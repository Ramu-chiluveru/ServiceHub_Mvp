...
import { 
  ...
  Calendar, Home, DollarSign, TrendingUp, Award, Zap, Map, Camera, 
  FileText, Navigation, Wind, Search, X, Send, MapPin, Clock, Star, 
  XCircle, Settings, Wrench, Droplets, PaintBucket, Phone, MessageCircle, 
  Battery, Wifi, Signal, Filter, Menu, Eye, Edit, Plus, Minus, RefreshCw, 
  AlertCircle, ThumbsUp, Shield, Truck, Timer, Activity, Info, TreePalm, 
  Bug, Sparkles, Sofa, Briefcase 
} from 'lucide-react';
